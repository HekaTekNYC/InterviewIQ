      ...
      <div className="container mx-auto">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-4">
            ...
            <a href="#" className="text-white hover:text-primary">Flashcards</a>
            <div className={`relative group ${isDropdownOpen ? 'dropdown-open' : ''}`}>
              <button onClick={toggleDropdown} className="text-white hover:text-primary">Options</button>
              {isDropdownOpen && (
                <div className="absolute mt-2 space-y-2 bg-white text-gray-700 rounded-md shadow-lg">
                  <a href="#" className="block px-4 py-2 hover:text-primary">Option 1</a>
                  <a href="#" className="block px-4 py-2 hover:text-primary">Option 2</a>
                  <a href="#" className="block px-4 py-2 hover:text-primary">Option 3</a>
                </div>
              )}
            </div>
            <a href="#" className="text-white hover:text-primary">About</a>
            <a href="#" className="text-white hover:text-primary">Contact</a>
          </div>
